...
>
```
*Nota: El `src` inicial debe ser un placeholder ligero o un SVG transparente.*
...
En Scatola, es preferible usar `DOMContentLoaded.addEventOrExecute` para asegurar que el DOM esté listo sin bloquear el renderizado inicial.
