...
Esta habilidad se activara cuando el usuario quiera crear una nueva "Skill" (habilidad) o modificar alguna en su workspace, especialmente si desea que las instrucciones y la estructura estén en español.
...
- Las habilidades deben contener un trigger para su activación.
